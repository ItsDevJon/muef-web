...
const SearchBar = () => {
    ...
    return (
        <div className="bg-white py-6 search-bar-shadow -mt-8 rounded-lg container mx-auto px-4 sm:px-6 lg:px-8 z-10 relative">
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                <div className="relative flex-grow w-full md:w-auto">
                    <span className="material-icons absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 icon-sm">search</span>
                    <input 
                        type="text" 
                        value={searchQuery}
                ...
                <div className="relative flex-grow w-full md:w-auto">
                    <span className="material-icons absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 icon-sm">location_on</span>
                    <input 
                        type="text" 
                        value={locationQuery}
                ...
                <button className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold px-8 py-3 rounded-lg w-full md:w-auto">Search</button>
            </div>
        </div>
    )
}
